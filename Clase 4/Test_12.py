...
print("Cadena con eemplazos, tiene el siguiente valor actualizado: {}".format(cadena_2))

"""Eliminación de espacios en blanco de mi cadena (después): .rstrip()"""
cadena_3 = 'Conexión a base de datos con Python      '
cadena_4 = cadena_3.rstrip()

print(cadena_3)
print('Mi cadena sin espacios en blanco es la siguiente: {}'.format(cadena_4))

"""Eliminación de espacios en blanco de mi cadena (antes): .lstrip()"""
